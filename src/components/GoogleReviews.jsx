...
const reviews = [
  ...
  },
  {
    name: 'Kan',
    rating: 5,
    text: '感谢 Ryan Dai 的专业服务。他确实对澳洲房地产市场有很深的研究，不是光靠感觉，而是能拿出详尽的数据和独到的见解来支持决策。整个过程他完全站在我的立场，帮我避开了不少坑，最后也争取到了一个非常合理的价格。他让我明白，买家代理的价值在于信息差和谈判力。真心推荐！',
  },
  {
    name: 'Gulian',
    rating: 5,
    text: 'Dai 是很负责的买家中介，整个服务过程能做到很好的沟通，买到的房子也确实很有性价比，租售比高。强烈推荐！',
  },
  {
    name: 'Xinling',
    rating: 5,
    text: '超级感谢Dai帮我找到珀斯的好房子，很推荐他，整个服务细致耐心！对每个区都有自己准确的见解，每次消息回复的很及时。',
  },
  {
    name: 'MengYu',
    rating: 5,
    text: '不错不错！消息回复及时，也不讲废话回答到点，遇到问题处理得很快效率高，别无他求ba',
  },
  {
    name: 'Tianyi',
    rating: 5,
    text: '这次买房的服务真的特别好！工作人员特别细心周到，不管我有什么问题，都能及时解答，一点都不耽误事。最后顺利买到了这套特别值得的投资房，我特别满意，特别推荐！',
  },
]
